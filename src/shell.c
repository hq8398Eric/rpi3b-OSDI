...
void help() {
	...
	uart_printf("async 		  : async uart test\r\n");
	uart_printf("dtv		  : print dtb\r\n");
	uart_printf("exit 		  : exit\r\n");
	uart_printf("page 		  : page test\r\n");
	uart_printf("malloc 	  : malloc test\r\n");
	uart_printf("load 		  : load code from file\r\n");
	uart_printf("thread 	  : thread test\r\n");
	uart_printf("fork		  : fork test\r\n");
	uart_printf("timer	 	  : enable timer\r\n");
